...
scrape_configs:
  - job_name: 'prometheus'
    static_configs:
      - targets: ['54.229.9.22:9090']

  - job_name: 'node_exporter'
    static_configs:
      - targets: ['54.229.9.22:9100']

  - job_name: 'app'
    static_configs:
      - targets: ['54.229.9.22:5000']
EOL
...
echo "- Prometheus: http://54.229.9.22:9090"
echo "- Grafana: http://54.229.9.22:3000 (Default login: admin / admin)"
echo "- Node Exporter metrics: http://54.229.9.22:9100/metrics"
